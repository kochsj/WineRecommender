...
//https://github.com/dkk/WrappingHStack/blob/main/Sources/WrappingHStack/WrappingHStack.swift
...
public extension WrappingHStack {
    ...
    init<Data: RandomAccessCollection, Content: View>(_ data: Data, id: KeyPath<Data.Element, Data.Element> = \.self, alignment: HorizontalAlignment = .center, spacing: Spacing = .constant(20), lineSpacing: CGFloat = 15, @ViewBuilder content: @escaping (Data.Element) -> Content) {
